...
/**
 * Props for the FilledFolder component.
 */
interface FilledFolderProps {
  /** The name displayed below the folder */
  folderName: string;
  /** The number of files shown below the folder name */
  folderQuantity: number;
}

/**
 * An animated 3D folder component with sheets that pop out on hover.
 * Uses layered images (back, front, line, sheets) with framer-motion
 * variants for interactive hover animations.
 *
 * @component
 * @example
 * ```tsx
 * <FilledFolder folderName="Documents" folderQuantity={12} />
 * ```
 *
 * @param props - Folder display configuration
 * @returns Animated folder component
 */
const FilledFolder = ({ folderName, folderQuantity }: FilledFolderProps): JSX.Element => {
    ...
    >
      ...
      >
        ...
        <motion.img
          ...
          variants={{
            rest: { y: "22%", scale: 0.96, rotate: 0 },
            hover: { y: "-12%", scale: 1, rotate: -sideRotation },
          }}
