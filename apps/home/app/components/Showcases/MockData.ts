...
export const CPU_HISTORY: number[] = [
  32, 35, 38, 42, 40, 45, 48, 52, 50, 47, 44, 46, 50, 53, 48, 45, 42, 44, 47, 45,
];

/** Historical RAM usage data points for sparkline */
export const RAM_HISTORY: number[] = [
  58, 60, 62, 65, 63, 64, 66, 68, 67, 65, 63, 64, 66, 68, 70, 69, 67, 65, 66, 68,
];

/** Historical network download data points (MB/s) */
export const NETWORK_DOWNLOAD_HISTORY: number[] = [
  8.2, 9.1, 10.5, 12.3, 11.8, 10.2, 9.5, 11.0, 12.8, 13.5, 12.0, 10.8, 11.5, 13.2, 14.0, 12.5, 11.0,
  10.5, 12.0, 11.5,
];

/** Historical network upload data points (MB/s) */
export const NETWORK_UPLOAD_HISTORY: number[] = [
  3.1, 3.5, 4.2, 4.8, 4.5, 3.8, 3.2, 4.0, 4.5, 5.0, 4.2, 3.8, 4.1, 4.8, 5.2, 4.5, 3.9, 3.5, 4.0,
  3.8,
];
