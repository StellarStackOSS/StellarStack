...
export const metadata: Metadata = {
  ...
  description:
    "The modern, open-source game server hosting panel. Deploy, manage, and scale game servers with an intuitive interface built for developers and hosting providers.",
  keywords: [
    "game server",
    "hosting",
    "minecraft",
