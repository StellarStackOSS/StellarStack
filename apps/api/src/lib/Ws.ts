...
import type { WSEventType, WSEvent, ConnectedClient } from "./WsTypes";
import { db } from "./Db";

// Re-export types for backwards compatibility
export type { WSEventType, WSEvent, ConnectedClient } from "./WsTypes";
    ...
    return {
      ...
      node: server.node
        ? {
            ...
            sftpPort: server.node.sftpPort,
            isOnline: server.node.isOnline,
