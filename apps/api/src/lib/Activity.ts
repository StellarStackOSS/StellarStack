...
import { db } from "./Db";
import type { ActivityEvent, LogActivityOptions, ActivityLogQuery } from "./ActivityTypes";

// Re-export types for backwards compatibility
export type { ActivityEvent, LogActivityOptions, ActivityLogQuery } from "./ActivityTypes";
...
export const QueryActivityLogs = async (query: ActivityLogQuery) => {
  const where: {
    serverId?: string;
    userId?: string;
    event?: string | { startsWith: string };
