...
import { generateInitialLines, generateRandomLine, generateStartupSequence } from "@stellarUI/components/Console/mock-data";
import type { ConsoleLine } from "@stellarUI/components/Console/types";
