...
export const Default: Story = {
  render: () => (
    <Command className="w-[400px] rounded-lg border border-border shadow-md">
    ...
    <Command className="w-[400px] rounded-lg border border-border shadow-md">
      ...
      <CommandList>
        ...
        <CommandGroup heading="Settings">
          <CommandItem><Settings className="mr-2 h-4 w-4" /> General</CommandItem>
          <CommandItem><Settings className="mr-2 h-4 w-4" /> Security</CommandItem>
        </CommandGroup>
      </CommandList>
    </Command>
  ),
